...
- 6ca4bbf: Prompts come from `@clack/prompts` 1.x (ESM-only, which the CLI already is). Same
  questions, same flags.
- 7c5ea27: Templates depend on `@craftzbay/ui@^0.11.3` instead of `^0.9.0`. On a 0.x library a
