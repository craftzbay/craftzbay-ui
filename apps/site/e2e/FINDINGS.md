...
| ---------------------------- | ----: | -----: | -----: | ------: |
| `admin-interactions.spec.ts` |     9 |      9 |      0 |       0 |
| `docs.spec.ts`               |   218 |    218 |      0 |       0 |
| `i18n.spec.ts`               |   100 |    100 |      0 |       0 |
| `templates-flows.spec.ts`    |    10 |     10 |      0 |       0 |
| `templates.spec.ts`          |   300 |    300 |      0 |       0 |
| `visual.spec.ts`             |    12 |     12 |      0 |       0 |
| **Total**                    |   649 |    649 |      0 |       0 |
