...
function FooterColumn({ heading, links }: { heading: string; links: FooterLink[] }) {
  const linkClass =
    'relative before:absolute before:top-1/2 before:left-1/2 before:size-[max(100%,1.5rem)] before:-translate-x-1/2 before:-translate-y-1/2 before:content-[""] rounded-sm outline-none hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background';
  return (
    <div>
        ...
        footer={
          <>
            ...
            <button
              ...
              className="text-accent focus-visible:ring-ring focus-visible:ring-offset-background relative rounded-sm font-medium outline-none before:absolute before:top-1/2 before:left-1/2 before:size-[max(100%,1.5rem)] before:-translate-x-1/2 before:-translate-y-1/2 before:content-[''] hover:underline focus-visible:ring-2 focus-visible:ring-offset-2"
            >
              {t('backToSite')}
            </button>
          </>
