  ...
  api: [
    {
      rows: [
        ...
        { name: 'autoResize', type: 'boolean', default: 'false', description: 'Grow height with content.' },
        { name: 'rows', type: 'number', default: '3', description: 'Initial visible rows.' },
        { name: 'hideLabel', type: 'boolean', default: 'false', description: 'Visually hide the label.' },
